from hworkflow.v2.projects import COCODet
...
project = COCODet("COCO-Detection", git_repo, sheet_id, access_token, secret_file, token_file,
                 sub_sheet="COCO", worker_id=1, **envs)
row = 30
